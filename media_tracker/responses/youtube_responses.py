...
YTPlaylistVideoPublic.model_rebuild()

YTPlaylistVideoResponse: TypeAlias = Union[
    list[YTPlaylistVideoPublic]
]

YTPlaylistVideoResponseItem: TypeAlias = Union[
    YTPlaylistVideoPublic
]